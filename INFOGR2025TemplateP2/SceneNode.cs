...
namespace Template
{
    public class SceneNode
    {
        ...
        public void Render(Matrix4 parentTransform, Matrix4 worldToCamera, Matrix4 cameraToScreen, Shader defaultShader, Texture defaultTexture)
        {
            ...
            if (Mesh != null)
            {
                ...
                Mesh.Render(shaderToUse, objectToScreen, objectToWorld, textureToUse);
            }
            ...
            {
                child.Render(worldTransform, worldToCamera, cameraToScreen, defaultShader, defaultTexture);
            }
        }
